---
title: "SDL PAND v1.9 - Camp de Tarragona"
output: 
...
casosTotal <- casosTotal %>% filter(regiosanitariacodi == 6200)
...
newInfectives <- read.csv2("../../models/SDL/Pandemiav1.9/experiment/6200/data/traces/newInfectiveDetectedDiary.csv")
...
write.csv(casosDiaris,"./SDLModel/6200_casosDiaris.csv",row.names = FALSE)
