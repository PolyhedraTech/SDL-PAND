---
title: "SDL PAND v1.9 - Catalunya Central"
output: 
...
casosTotal <- casosTotal %>% filter(regiosanitariacodi == 6700)
...
infective <- read.csv2("../../models/SDL/Pandemiav1.9/experiment/6700/data/traces/totalInfective.csv")
recovered <- read.csv2("../../models/SDL/Pandemiav1.9/experiment/6700/data/traces/totalRecovered.csv")
deaths <- read.csv2("../../models/SDL/Pandemiav1.9/experiment/6700/data/traces/totalDeceased.csv")

#nous_casos_model <- read.csv("../new_cases.csv", header = FALSE)
newInfectives <- read.csv2("../../models/SDL/Pandemiav1.9/experiment/6700/data/traces/newInfectiveDetectedDiary.csv")
...
write.csv(casosDiaris,"./SDLModel/6700_casosDiaris.csv",row.names = FALSE)
