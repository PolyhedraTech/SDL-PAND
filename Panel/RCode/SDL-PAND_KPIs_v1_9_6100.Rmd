...
casosTotal <- casosTotal %>% filter(regiosanitariacodi == 6100)
...
# infective <- read.csv2("../../models/SDL/Pandemiav1.9/experiment/6100/data/traces/totalInfective.csv")
# recovered <- read.csv2("../../models/SDL/Pandemiav1.9/experiment/6100/data/traces/totalRecovered.csv")
# deaths <- read.csv2("../../models/SDL/Pandemiav1.9/experiment/6100/data/traces/totalDeceased.csv")

#nous_casos_model <- read.csv("../new_cases.csv", header = FALSE)
# newInfectives <- read.csv2("../../models/SDL/Pandemiav1.9/experiment/6100/data/traces/newInfectiveDetectedDiary.csv")
# 
...
# write.csv(casosDiaris,"./SDLModel/6100_casosDiaris.csv",row.names = FALSE)
