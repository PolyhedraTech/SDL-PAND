---
title: "SDL PAND v1.9 - Metropolità nord"
output: 
...
casosTotal <- casosTotal %>% filter(regiosanitariacodi == 7802)
...
infective <- read.csv2("../../models/SDL/Pandemiav1.9/experiment/7802/data/traces/totalInfective.csv")
recovered <- read.csv2("../../models/SDL/Pandemiav1.9/experiment/7802/data/traces/totalRecovered.csv")
deaths <- read.csv2("../../models/SDL/Pandemiav1.9/experiment/7802/data/traces/totalDeceased.csv")

#nous_casos_model <- read.csv("../new_cases.csv", header = FALSE)
newInfectives <- read.csv2("../../models/SDL/Pandemiav1.9/experiment/7802/data/traces/newInfectiveDetectedDiary.csv")
...
write.csv(casosDiaris,"./SDLModel/7802_casosDiaris.csv",row.names = FALSE)
