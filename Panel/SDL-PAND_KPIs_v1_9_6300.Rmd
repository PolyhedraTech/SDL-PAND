---
title: "SDL PAND v1.9 - Terres de l'Ebre"
output: 
...
casosTotal <- casosTotal %>% filter(regiosanitariacodi == 6300)
...
infective <- read.csv2("../../models/SDL/Pandemiav1.9/experiment/6300/data/traces/totalInfective.csv")
recovered <- read.csv2("../../models/SDL/Pandemiav1.9/experiment/6300/data/traces/totalRecovered.csv")
deaths <- read.csv2("../../models/SDL/Pandemiav1.9/experiment/6300/data/traces/totalDeceased.csv")

#nous_casos_model <- read.csv("../new_cases.csv", header = FALSE)
newInfectives <- read.csv2("../../models/SDL/Pandemiav1.9/experiment/6300/data/traces/newInfectiveDetectedDiary.csv")
...
write.csv(casosDiaris,"./SDLModel/6300_casosDiaris.csv",row.names = FALSE)
